...
from encoder.ImRaEncoder import ImRaEncoder
...
class Achelous3T(nn.Module):
    def __init__(self, num_det, num_seg, phi='SO', image_channels=3, radar_channels=3, resolution=320,
        ...
        self.imra_endocer = ImRaEncoder(resolution=resolution, phi=phi, backbone=backbone, radar_channels=radar_channels)
    ...
    def forward(self, input_image, input_radar):
        ...
        image_features, radar_features = self.imra_endocer(input_image, input_radar)
        image_feature1, image_feature2, image_feature3, image_feature4, image_feature5 = image_features
        radar_feature1, radar_feature2, radar_feature3, radar_feature4, radar_feature5 = radar_features
