...
class FusionOrigin(nn.Module):
    def __init__(self, phi='S0'):
        super(FusionOrigin, self).__init__()
    ...
    def forward(self, image_features_fpn, radar_features):
        map_stage5, map_stage4, map_stage3 = image_features_fpn
        ...
        return p3_fuse_out, p4_fuse_out, p5_fuse_out
