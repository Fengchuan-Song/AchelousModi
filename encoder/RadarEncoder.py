...
class RCNet(nn.Module):
    ...
    def forward(self, x):
        radar_map_stage1, radar_map_stage2, radar_map_stage3, radar_map_stage4, radar_map_stage5 = self.forward_blocks(x)
        return radar_map_stage1, radar_map_stage2, radar_map_stage3, radar_map_stage4, radar_map_stage5
